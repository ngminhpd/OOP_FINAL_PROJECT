...
namespace BankSystem {
    ...
    protected:
        ...
        double HanMucTinDung, NoTinDung;
    public:
    ...
    public:
        TaiKhoanThanhToan(string a, string b, double c, string p="1234", bool k=false, string hang="Thành viên", double dv=0, double hmTD=0, double noTD=0) 
            : TaiKhoan(a,b,c,p,k,hang,dv,hmTD,noTD) {}
    ...
    public:
        TaiKhoanTietKiem(string a, string b, double c, double ls, int kh, string p="1234", bool k=false, string hang="Thành viên", double dv=0, double hmTD=0, double noTD=0) 
            : TaiKhoan(a,b,c,p,k,hang,dv,hmTD,noTD), LaiSuat(ls), KyHan(kh) {}
    ...
    class TaiKhoanTinDung : public TaiKhoan {
        double HanMuc;
    public:
        TaiKhoanTinDung(string a, string b, double c, double hm, string p="1234", bool k=false, string hang="Thành viên", double dv=0) 
            : TaiKhoan(a,b,c,p,k,hang,dv), HanMuc(hm) {}
